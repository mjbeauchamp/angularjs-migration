...
let CardComponent = {
  selector: 'ccCard', //SAME AS DIRECTIVE NAME. WILL MAP TO HTML <cc-card>
  template: `
  <div class="col-md-6">
...
</div>`, //He prefers to bring the template inline, rather than copying the templateURL property.
  //But it's from the same card.html file.
  bindings: {
    user: '='
  },
